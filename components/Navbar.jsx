    ...
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        ...
        >
          ...
          <span className="w-12 h-88 rounded bg-white text-black flex items-center justify-center">
            .white
          </span>
        </Link>
      </div>
      ...
      <div className="md:hidden">
        ...
        {open && (
          ...
          >
            {links.map((link) => (
              <motion.div variants={listItenVariants} className=""  key={link.title}>
              <Link href={link.url}>
                {link.title}
              </Link>
              </motion.div>
